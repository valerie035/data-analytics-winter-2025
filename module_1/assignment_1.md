...
---I asked Chat GPT this question:"how do i create a custom color palette in google sheets for my chart?"
  Both ChatGPT and Google returned similar answers and both worked. I perferred Googles answers because a video appeared with the result which helped me see how to apply these custom color changes.

  <img width="1014" alt="Screenshot 2025-01-16 at 5 04 56 AM" src="https://github.com/user-attachments/assets/6a83a10a-53d6-4b0d-951f-6aa4aca4daac" />

<img width="990" alt="Screenshot 2025-01-16 at 5 06 15 AM" src="https://github.com/user-attachments/assets/4b32d310-6537-4a7f-8b76-5729187bd59a" />
...
---Google seems to answers question that apply to Google products more efficiently and with more options of how to learn the answer. This is especially useful when a visul demonstration or image can expand the teaching. Chat GPT is mostly useful when a simple text answer or explanation is preferred. 
...
---My experience with Chat GPT and Googgle for this assignment has me leaning to a bit more confidence in Googles AI tool. However, I likely have a bias becuase I have much experience using Googes AI tool and not much using ChatGPT.
